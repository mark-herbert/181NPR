 ...
 */
public class VisitorsArchiveFrame extends javax.swing.JFrame {

    /**
     * Creates new form VisitorsArchiveFrame
     */
    ...
    private String path = "";
    public VisitorsArchiveFrame(NPRInterface client, String user) throws IOException {
        initComponents();
        this.client = client;
        this.user = user;
...
//                Logger.getLogger(AdminArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            ...
            model = (DefaultTableModel) visitorsloginfotable.getModel();
            for(VisitorImpl v : client.getAllVisitor()){
...
//            Logger.getLogger(VisitorsArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            new MessageDialog().error(this, ex.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        visitorsloginfotable = new javax.swing.JTable();
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("visitorsarchive.png")).getImage());
        setUndecorated(true);
        setResizable(false);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Visitors Archive", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rondalo", 0, 24))); // NOI18N
        ...
        visitorsloginfotable.setAutoCreateRowSorter(true);
        visitorsloginfotable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Date", "Visitors ID", "Full Name", "Time In", "Time Out", "Purpose", "Resident"
            }
        ) {
        ...
        visitorsloginfotable.setGridColor(new java.awt.Color(204, 204, 204));
        visitorsloginfotable.getTableHeader().setResizingAllowed(false);
        visitorsloginfotable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(visitorsloginfotable);
    ...
    private void tabletoPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoPDFActionPerformed
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream(path+"\\PDF\\VisitorsArchive.pdf"));
            document.open();
            ...
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\PDF\\VisitorsArchive.pdf' successfully", "Message",
...
//            Logger.getLogger(VisitorsArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tabletoExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoExcelActionPerformed
        try {
            ...
            exp.fillData(visitorsloginfotable, new File(path+"\\EXCEL\\VisitorsArchive.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\EXCEL\\VisitorsArchive.xls' successfully", "Message",
                    JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
//            ex.printStackTrace();
            new MessageDialog().error(this, ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorsArchiveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new VisitorsArchiveFrame(null,null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(VisitorsArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTable visitorsloginfotable;
