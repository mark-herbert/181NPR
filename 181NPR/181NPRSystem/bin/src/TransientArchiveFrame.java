 ...
 */
public class TransientArchiveFrame extends javax.swing.JFrame {

    /**
     * Creates new form TransientArchiveFrame
     */
    ...
    private String path = "";
    public TransientArchiveFrame(NPRInterface client, String user) throws IOException {
        initComponents();
        this.client = client;
        this.user = user;
...
//                Logger.getLogger(AdminArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            ...
            model = (DefaultTableModel) transientpersonalinfo.getModel();
            for(TransientImpl t : client.getAllTransientInfo()){
            ...
            for (TransientImpl t : client.getAllTransientCheckinDetails()) {
                model.addRow(new Object[]{
                    t.getDateEntered(),
                    t.getFull_name(),
                    t.getArrival(),
            ...
            for(TransientImpl t : client.getAllTransientGuest()){
                model.addRow(new Object[]{
                    t.getFull_name(),
                    t.getAdditionalGuest()
                });
            }
...
//            Logger.getLogger(TransientArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        transientpersonalinfo = new javax.swing.JTable();
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("transientarchive.png")).getImage());
        setUndecorated(true);
        setResizable(false);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Transient Archive", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rondalo", 0, 24))); // NOI18N
        ...
        transientpersonalinfo.setAutoCreateRowSorter(true);
        transientpersonalinfo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Transient ID", "Full Name", "Mobile No.", "Email", "Address", "Room"
            }
        ) {
        ...
        transientpersonalinfo.setEnabled(false);
        transientpersonalinfo.setGridColor(new java.awt.Color(204, 204, 204));
        transientpersonalinfo.getTableHeader().setResizingAllowed(false);
        transientpersonalinfo.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(transientpersonalinfo);
        ...
        checkintable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Full Name", "Arrival", "End", "Registration ID", "Room", "Relation"
            }
        ) {
            Class[] types = new Class [] {
        ...
        checkintable.setGridColor(new java.awt.Color(204, 204, 204));
        ...
        jTabbedPane2.addTab("Check-In Details", jPanel3);
        ...
        guesttable.setFocusTraversalPolicyProvider(true);
        guesttable.setGridColor(new java.awt.Color(204, 204, 204));
    ...
    private void tabletoPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoPDFActionPerformed
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream(path+"\\PDF\\" + title + " TransientArchive.pdf"));
            document.open();
            ...
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\PDF\\" + title + "TransienttArchive.pdf' successfully", "Message",
...
//            Logger.getLogger(TransientArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tabletoExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoExcelActionPerformed
        ...
        try {
            ...
            if (jTabbedPane2.getSelectedIndex() == 0) {
                exp.fillData(transientpersonalinfo, new File(path+"\\EXCEL\\Transient Personal Information TransientArchive.xls"));
            } else if (jTabbedPane2.getSelectedIndex() == 1) {
                exp.fillData(checkintable, new File(path+"\\EXCEL\\Transient Check-in Details TransientArchive.xls"));
            } else {
                exp.fillData(guesttable, new File(path+"\\EXCEL\\Transient Guests TransientArchive.xls"));
            }
            JOptionPane.showMessageDialog(null, "Data saved at " +path
...
//            ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransientArchiveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TransientArchiveFrame(null, null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(TransientArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTable transientpersonalinfo;
