 ...
 */
public class FurnitureArchiveFrame extends javax.swing.JFrame {

    /**
     * Creates new form FurnitureArchiveFrame
     */
    ...
    private String path = "";
    public FurnitureArchiveFrame(NPRInterface client, String user) throws IOException {
        initComponents();
        this.client = client;
        this.user = user;
        try {
...
//                Logger.getLogger(AdminArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            ...
            for(FurnitureImpl f : client.getAllFurniture()){
...
//            Logger.getLogger(FurnitureArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            new MessageDialog().error(this, ex.getMessage());
        }
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("furniture.png")).getImage());
        setUndecorated(true);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Furniture Archive", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rondalo", 0, 24))); // NOI18N
        ...
        residentlogsinfotable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Name", "Control #", "Color", "Brand", "Purchase Date"
            }
        ) {
    ...
    private void tabletoPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoPDFActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Data saved at " +path
                    + "'\\PDF\\FurnitureArchive.pdf' successfully", "Message",
...
//            Logger.getLogger(TimeInOutArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tabletoExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoExcelActionPerformed
        try {
            ...
            exp.fillData(residentlogsinfotable, new File(path+"\\EXCEL\\FurnitureArchive.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\EXCEL\\FurnitureArchive.xls' successfully", "Message",
                    JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
//            ex.printStackTrace();
            new MessageDialog().error(this, ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FurnitureArchiveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FurnitureArchiveFrame(null,null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(FurnitureArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
