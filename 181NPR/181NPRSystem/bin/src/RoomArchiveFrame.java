 ...
 */
public class RoomArchiveFrame extends javax.swing.JFrame {

    /**
     * Creates new form RoomArchiveFrame
     */
    ...
    private String path = "";
    public RoomArchiveFrame(NPRInterface client, String user) throws IOException {
        initComponents();
        this.client = client;
        this.user = user;
...
//                Logger.getLogger(AdminArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            ...
            model = (DefaultTableModel) roominfotable.getModel();
            for(RoomImpl r : client.getAllRoom()){
...
//            Logger.getLogger(RoomArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            new MessageDialog().error(this, ex.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("roomarchive.png")).getImage());
        setUndecorated(true);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Room Archive", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rondalo", 0, 24))); // NOI18N
        ...
        roominfotable.setAutoCreateRowSorter(true);
        roominfotable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Dorm", "Room ID", "Number", "Type", "Status"
            }
        ) {
        ...
        roominfotable.setEnabled(false);
        roominfotable.setGridColor(new java.awt.Color(204, 204, 204));
        roominfotable.getTableHeader().setResizingAllowed(false);
        roominfotable.getTableHeader().setReorderingAllowed(false);
    ...
    private void tabletoPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoPDFActionPerformed
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream(path+"\\PDF\\RoomArchive.pdf"));
            document.open();
            ...
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\PDF\\RoomArchive.pdf' successfully", "Message",
...
//            Logger.getLogger(RoomArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tabletoExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoExcelActionPerformed
        ...
        try {
            ...
            exp.fillData(roominfotable, new File(path+"\\EXCEL\\RoomArchive.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                    + "'\\EXCEL\\RoomArchive.xls' successfully", "Message",
                    JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
//            ex.printStackTrace();
            new MessageDialog().error(this, ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoomArchiveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new RoomArchiveFrame(null,null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(RoomArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
