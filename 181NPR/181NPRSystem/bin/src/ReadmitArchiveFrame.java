 ...
 */
public class ReadmitArchiveFrame extends javax.swing.JFrame {

    /**
     * Creates new form ReadmitArchiveFrame
     */
    ...
    private String path = "";
    public ReadmitArchiveFrame(NPRInterface client, String user) throws IOException {
        initComponents();
        this.client = client;
        this.user = user;
        try {
...
//                Logger.getLogger(AdminArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
            ...
            for(ResidentImpl r : client.getAllLeavedResidentPersonal()){
            ...
            for(ResidentImpl r : client.getAllLeavedResidentContact()){
                model.addRow(new Object[]{
                    r.getFullName(),
                    r.getId(),
                    r.getBirthdate()
            ...
            for(ResidentImpl r : client.getAllLeavedResidentAddress()){
                model.addRow(new Object[]{
                    r.getFullName(),
                    r.getId(),
                    r.getBirthdate()
            ...
            for(ResidentImpl r : client.getAllLeavedResidentStatus()){
                model.addRow(new Object[]{
                    r.getFullName(),
                    r.getId(),
                    r.getBirthdate()
...
//            Logger.getLogger(ReadmitArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("readmit.png")).getImage());
        setUndecorated(true);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Leaved Resident Archive", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Rondalo", 0, 24))); // NOI18N
    ...
    private void tabletoPDF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoPDF1ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                + "'\\PDF\\"+title+"ReadmitArchive.pdf' successfully", "Message",
...
//            Logger.getLogger(ReadmitArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tabletoExcel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabletoExcel1ActionPerformed
        ...
        try {
            ...
            if (jTabbedPane2.getSelectedIndex() == 0) {
                exp.fillData(residentpersonalinfotable, new File(path+"\\EXCEL\\PersonalInformationReadmitArchive.xls"));
                title = "PersonalInformation";
            }else if (jTabbedPane2.getSelectedIndex() == 1) {
                exp.fillData(residentcontactinfotable, new File(path+"\\EXCEL\\ContactInformationReadmitArchive.xls"));
                title = "ContactInformation";
            }else if (jTabbedPane2.getSelectedIndex() == 2) {
                exp.fillData(residentaddresstable, new File(path+"\\EXCEL\\AddressInformationReadmitArchive.xls"));
                title = "AddressInformation";
            }else if (jTabbedPane2.getSelectedIndex() == 3) {
                exp.fillData(residentstatustable, new File(path+"\\EXCEL\\StatusReadmitArchive.xls"));
                title = "Status";
            }
            JOptionPane.showMessageDialog(null, "Data saved at " + path
                + "'\\EXCEL\\"+title+"ReadmitArchive.xls' successfully", "Message",
                JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
//            ex.printStackTrace();
            new MessageDialog().error(this, ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadmitArchiveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ReadmitArchiveFrame(null,null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(ReadmitArchiveFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
